...
import com.fitgeek.memorix.services.QuizGenerationService;
import com.fitgeek.memorix.services.RateLimitService;
...
public class QuizGenerationServiceImpl implements QuizGenerationService {
    ...
    public void deleteQuiz(Long quizId) {
        ...
        Quiz quiz = quizRepository.findByIdAndOwnerId(quizId, owner.getId())
                .orElseThrow(() -> new BusinessException("Quiz not found or access denied", HttpStatus.NOT_FOUND));
